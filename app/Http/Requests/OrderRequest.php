...
class OrderRequest extends FormRequest
{
    ...
    {
        return [
            'date_generation' => ['required', 'date', 'after_or_equal:today'],
    ...
    public function messages(): array
    {
        return [
            ...
            'phone_number.int' => __('El número de teléfono debe ser una cadena de texto.'),
            ...
            'cell_number.int' => __('El número de celular debe ser una cadena de texto.'),
