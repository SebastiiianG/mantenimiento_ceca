...
class OrderRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'devices.required' => __('Debes añadir al menos un dispositivo.'),
            ...
            'devices.*.cg_kind_object_id.required'=>'El tipo de objeto es requerido',
