        ...
        <template #header>
            ...
            <div class="bg-cremaUAEH py-10 md:rounded-lg mt-3">
                ...
                <div class="mt-8 overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-300 break-all break-words ">
                        <thead class="bg-rojoMedioUAEH">
                            <tr>
                                <th class="py-3 px-2 sm:px-4 text-center text-sm font-semibold text-white">
                                    Marca
                                </th>
                                <th class="py-3 px:2 sm:px-4 text-center text-sm font-semibold text-white">
                                    Acciones
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            <tr v-for="cgBrand in cgBrands.data" :key="cgBrand.id">
                                <td class="py-4 px:2 sm:px-4 text-center text-gray-900
                                whitespace-nowrap
