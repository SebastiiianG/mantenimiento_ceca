                ...
                <div class="px-4 sm:px-6 lg:px-8">
                    <div class="sm:flex sm:items-center">
                        ...
                        <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                            <Link v-if="$page.props.user.permissions.includes('create failures')"
                                ...
                                :href="route('cgKindFailures.create')">
                            Añadir Falla
                            </Link>
                        </div>
                    </div>
                    <div class="flex flex-col justify-between sm:flex-row mt-6">
                        <div class="relative text-sm text-gray-800 col-span-3">
                            ...
                            <!--Input de búsqueda-->
                            <input v-model="searchQuery" type="text" autocomplete="off" placeholder="Buscar falla"
                                id="search"
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                <tr v-for="cgKindFailure in cgKindFailures.data" :key="cgKindFailure.id">
                                    ...
                                    <td class="py-4 px-6 text-center">
                                        <Link :href="route('cgKindFailures.edit', cgKindFailure.id)"
                                            class="text-naranjaUAEH hover:underline mx-2"
                                            v-if="$page.props.user.permissions.includes('update failures')">
                                        Editar</Link>
                                        <button @click="deleteCgKindFailure(cgKindFailure)"
                                            class="text-rojoUAEH hover:underline mx-2"
                                            v-if="$page.props.user.permissions.includes('delete failures')">
                                            Eliminar
                                        </button>
                                    </td>
                                </tr>
