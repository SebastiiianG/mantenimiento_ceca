    ...
    <ActionSection>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Una vez que tu cuenta haya sido borrada, todos sus recursos y datos serán permanentemente borrados. antes de borrar tu cuenta, por favor descarga cualquier información que deseas preservar.
            </div>
