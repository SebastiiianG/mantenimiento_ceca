    ...
    <ActionSection>
        ...
        <template #content>
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Por favor, introduce tu contraseña para confirmar que deseas cerrar sesión en sesiones activas de navegadores en todos tus dispositivos
                    <div class="mt-4">
                        <TextInput
                            ref="passwordInput"
