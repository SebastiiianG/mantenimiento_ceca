    ...
    <FormSection @submitted="$emit('submit', form)">
        ...
        <template #form>
            <div class="col-span-8 sm:col-span-8">
                ...
                <select class="bg-blancoDropdown mt-1 block w-full p-2 border border-gray-300 rounded-lg  focus:border-naranjaUAEH outline-none focus:ring-1 focus:ring-naranjaUAEH "
