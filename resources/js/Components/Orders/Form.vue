...
const state = reactive({
    form: props.form // asignas la referencia, no una copia
});
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-6 bg-transparent bg-opacity-0">
                ...
                <TextInput id="client_delivered" v-model="form.client_delivered" type="text"
                    autocomplete="client_delivered" class="mt-1 block w-full shadow-xl" />
            ...
            <div class="col-span-6 sm:col-span-6 bg-transparent bg-opacity-0">
                ...
                <select name="kperson_delivery" id="kperson_delivery" v-model="form.kperson_delivery"
                    class="bg-blancoDropdown mt-1 block w-full p-2 border-gray-300 rounded-lg shadow-md text-sm focus:border-naranjaUAEH focus:ring-naranjaUAEH">
                    <option v-for="cgKindPerson in cgKindPeople" :value="cgKindPerson.id"
                        class="whitespace-normal break-words">{{ cgKindPerson.kind_person }}
                    </option>
                </select>
            ...
            <div v-if="updating" class="col-span-6 sm:col-span-6 bg-transparent bg-opacity-0">
                ...
                <TextInput id="date_generation" v-model="form.date_generation" type="date" autocomplete="date_reception"
                    readonly class="mt-1 block w-full shadow-xl" />
            ...
            <div class="col-span-6 sm:col-span-6 bg-transparent bg-opacity-0">
                ...
                <TextInput id="date_reception" v-model="form.date_reception" type="date" autocomplete="date_reception"
            ...
            <div class="col-span-6 sm:col-span-6 bg-transparent bg-opacity-0">
                ...
                <select name="ceca_received" id="ceca_received" v-model="form.ceca_received"
                    class="bg-blancoDropdown mt-1 block w-full p-2 border-gray-300 rounded-lg shadow-md text-sm focus:border-naranjaUAEH focus:ring-naranjaUAEH">
            ...
            <div class="col-span-6 sm:col-span-6 bg-transparent bg-opacity-0">
                ...
                <select name="cg_academic_area_id" id="cg_academic_area_id" v-model="state.form.cg_academic_area_id"
                    class="bg-blancoDropdown mt-1 block w-full p-2 border-gray-300 rounded-lg shadow-md text-sm focus:border-naranjaUAEH focus:ring-naranjaUAEH">
                    <option value="none">Sin área académica</option>
                    <option v-for="cgAcademicArea in cgAcademicAreas" :value="cgAcademicArea.id"
            ...
            <div class="col-span-6 sm:col-span-6 bg-transparent bg-opacity-0">
                ...
                <select name="cg_dependency_id" id="cg_dependency_id" v-model="state.form.cg_dependency_id"
                    ...
                    class="bg-blancoDropdown mt-1 block w-full p-2 border-gray-300 rounded-lg shadow-md text-sm focus:border-naranjaUAEH focus:ring-naranjaUAEH">
                    <option v-for="cgDependency in cgDependencies" :value="cgDependency.id"
                        class="whitespace-normal break-words">
            ...
            <div v-if="updating" class="col-span-6 sm:col-span-6 bg-transparent bg-opacity-0">
                ...
                <TextInput id="client_received" v-model="form.client_received" type="text"
                    autocomplete="client_received" class="mt-1 block w-full shadow-xl" />
            ...
            <div v-if="updating" class="col-span-6 sm:col-span-6 bg-transparent bg-opacity-0">
                ...
                <TextInput id="delivery_date" v-model="form.delivery_date" type="date" autocomplete="delivery_date"
                    class="mt-1 block w-full shadow-xl" />
            ...
            <div v-if="updating" class="col-span-6 sm:col-span-6 bg-transparent bg-opacity-0">
                ...
                <select name="ceca_delivered" id="ceca_delivered" v-model="form.ceca_deliveries"
                    class="bg-blancoDropdown mt-1 block w-full p-2 border-gray-300 rounded-lg shadow-md text-sm focus:border-naranjaUAEH focus:ring-naranjaUAEH">
